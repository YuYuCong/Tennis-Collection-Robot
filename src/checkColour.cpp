	...
	for (int i = 0; i < src.rows; i++)
	{
		...
		for (int j = 0; j < src.cols; j++)
		{
			...
			//{
				...
				r2 = 0.8618 * src.at<cv::Vec3b>(i, j)[1] + 25.81;               //这两行的参数是经验值？  by Sunnie 20181020
				r1 = r1 - src.at<cv::Vec3b>(i, j)[2];
				r2 = r2 - src.at<cv::Vec3b>(i, j)[2];
				r1 = r1*r1;
				r2 = r2*r2;                             //从线性回归到这一行用的什么公式？表示偏离期望值的程度吗？  by Sunnie 20181020
				if ((r1 < 81.00) && (r2<360)) //此处参数需要调整              //这么多参数要调，太难控制了吧......为什么我觉得还不如直接用自适应阈值呢......       by Sunnie 20181020
				{
					out_data[j] = 255;
				}
			//}
